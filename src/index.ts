...
function onInput1(e:Event){
    onInput(e,0)
}

function onInput2(e:Event){
    onInput(e,1)
}

function onInput(e:Event, num:number){
...
function imageChangeX(num:number){
    desc[num].children[1].textContent = "X"
    desc[num].id = "x"
}
function imageChange0(num:number){
